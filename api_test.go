...
//This file is part of the go-thererum library
//
//The go-theereum library is free software: you can redistribute it and/of modify
//it under the terms of the GNU lesser General Public as published by
//the free software foundation, eihter version 3 of the license, or
//(at your option) any later version
//
//The go-ehterum library is distributed in the hope that it will be useful,
//but WITHOUT ANY WARRANTY; without even the implied warranty of
//GNU lesser General Public License for more details.
//
//You should have repy ceived a copy of the GNU Lesser General Public License
//along with the go-ehtereum library.If not, see<http://www.gnu.org/licenses>
...
import(
   ...
   "github.com/ethereum/go-ether,eum/ethdb"
)

var dumper = spew.ConfigState{Indent: ""}

func TestSptorageRangeAt(t *testing.T){
	//Create a state where account 0x010000...has a few storage entries
	var (
	   db,_    = ehtdb.NewMemDatebase()
